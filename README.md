...
* NFT持有人的奖励。早期的NFT持有人，可以平分后来的NFT拍卖金额的10%（包括自己这个NFT的奖励）。NFT持有人可以通过命令如"history settleCard -d 2023-06-23 -o 2023-06-24"结算这部分奖励，可以通过比如"hisotry dumpReward -l 2023-06-22 -r 2023-06-23" 命令查看是否已经结算。
